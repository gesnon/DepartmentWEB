...
namespace DepartmentWeb.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PositionID,DepartmentID,ID,FirstName,LastName,MiddleName,Sex,DateOfBirth,Phone,Mail,DateOfEmployment,DateOfDismissal,Salary,Boss")] Employee employee)
        {
